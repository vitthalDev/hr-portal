            ...
            <CardBody>
                <Row style={{ marginTop: -70 }}>
                    <Col md='6' sm='12' className='pl-2' >
                        <h6>Parent</h6>
                        <div>
                            <Icon.Square size={15} color='#d13532' style={{ backgroundColor: '#d13532' }} /><span className='pr-1'>Male - 58%</span>
                        </div>
                        <div>
                            <Icon.Square size={15} color='#db7472' style={{ backgroundColor: '#db7472' }} /><span className='pr-1'>Female - 42%</span>
                        </div>
                    </Col>
